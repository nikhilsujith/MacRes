...
public class FMViewReservationsActivity extends AppCompatActivity implements ViewReservations_ListAdapter.customButtonListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fmview_reservations);
    ...
    public void onButtonClickListner(String reservationID) {
        Intent intent = new Intent(FMViewReservationsActivity.this, FM_ViewSpecificReservation.class);
    ...
    {
        Cursor cursor = db.fm_view_reservations();
        ...
        if(cursor.getCount()>0) {
            ...
            adapter.setCustomButtonListner(FMViewReservationsActivity.this);
