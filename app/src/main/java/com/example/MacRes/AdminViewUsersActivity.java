...
public class AdminViewUsersActivity extends AppCompatActivity implements ViewUsers_ListAdapter.customButtonListener {
    ...
    public void onButtonClickListner(String username) {
        Intent intent = new Intent(AdminViewUsersActivity.this, Admin_ViewSpecificUser.class);
    ...
    public void populate()
    {
        ...
        adapter.setCustomButtonListner(AdminViewUsersActivity.this);
